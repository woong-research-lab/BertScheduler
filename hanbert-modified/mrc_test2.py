...
def convert_examples_to_features(examples, tokenizer, max_seq_length,
  ...
  for (example_index, example) in enumerate(examples):
    ...
    print('################ doc_tokens len = ', len(example.doc_tokens))
...
def input_fn_builder(input_data, tokenizer, seq_length, drop_remainder):
  ...
  def input_fn():
      return (tf.data.Dataset.from_generator(gen,
        ...
        output_shapes={'unique_ids': [None], 'input_ids': [None, seq_length], 'input_mask': [None, seq_length],'segment_ids': [None, seq_length]}))
