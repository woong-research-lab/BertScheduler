...
def create_optimizer(loss, init_lr, num_train_steps, num_warmup_steps, use_tpu, local_distributed):
  ...
  # if local_distributed:
  #   print("TowerOptimizer")
